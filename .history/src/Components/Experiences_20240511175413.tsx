        ...
        {ExperiencesList.map((experience, index) => {
          return (
            <div
              ...
              className="bg-blackGray px-2 sm:px-8 py-4 flex justify-between items-center rounded-3xl"
            >
              <div className="flex items-center gap-4 sm:gap-12">
                ...
                <div>
                  ...
                  <p className="text-gray max-sm:text-sm tracking-wider">
                    {experience.job}
                  </p>
                </div>
              </div>
              <div>
                <p className="text-whiteGray max-sm:text-sm tracking-widest text-end">
                  {experience.date}
                </p>
              </div>
            </div>
