            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-0 right-0 h-full ">
                  <div className="absolute h-full w-[2px] rounded-full bg-white top-0 right-3"></div>
                  <div className="absolute h-full w-[2px] rounded-full bg-white top-0 rotate-90 right-3"></div>
                </div>
              </div>
