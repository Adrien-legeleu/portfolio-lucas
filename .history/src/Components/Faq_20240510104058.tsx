...
export const Faq = () => {
  ...
  return (
    <div className="grid-cols-faq grid font-montserrat w-full">
      <div className="space-y-6">
        ...
        <div className="px-4 py-5 bg-blackGray rounded-3xl space-y-3">
      ...
      <div className="pl-10 space-y-5">
        {FaqQuestions.map((question, index) => {
          return (
            <div
              className="rounded-3xl bg-blackGray py-8 px-7 duration-300"
            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-0 right-0 h-full ">
                  <div className="absolute h-2/3 w-[2px] rounded-full bg-white top-1/2 -translate-y-1/2 right-3"></div>
                  <div className="absolute h-2/3 w-[2px] rounded-full bg-white top-1/2 rotate-90 -translate-y-1/2 right-3"></div>
                </div>
              </div>
              <div
                className={`${
