...
export const Faq = () => {
  ...
  return (
    <div className="xl:grid-cols-faq xl:grid space-y-20 font-montserrat w-full">
      <div className="space-y-6 w-full sm:w-2/3 lg:w-full m-auto">
      ...
      <div className="xl:pl-10 space-y-5">
          ...
          return (
            ...
            >
              <div className="relative">
                <h3 className="text-white text-sm sm:text-xl max-lg:pr-8 ">
                  {question.title}
                </h3>
                <div className="absolute top-0 right-0 h-full ">
                  <div
                    className={`absolute h-6 w-[2px] rounded-full bg-white top-1/2 ${
                      isQuestionOpen && index === indexQuestion
                        ? "rotate-90"
                        : "rotate-0"
                    } duration-200 -translate-y-1/2 right-3`}
                  ></div>
                  <div className="absolute h-6 w-[2px] rounded-full bg-white top-1/2 rotate-90 -translate-y-1/2 right-3"></div>
                </div>
              </div>
              <div
                className={`${
