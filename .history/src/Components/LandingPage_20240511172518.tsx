...
export const LandingPage = () => {
  return (
    <div className="flex max-[1050px]:flex-col max-[1050px]:gap-32 h-full items-center justify-center  font-montserrat">
      <div className="[1050px]:flex-1">
      ...
      <div className="[1050px]:flex-1 flex gap-8 flex-col items-center [1050px]:items-start max-[1050px]:text-center">
        <p className="text-whiteGray text-2xl max-[1050px]:text-center">
