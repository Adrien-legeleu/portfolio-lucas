export const Experiences = () => {
  return (
    <div className="py-32 space-y-10 font-montserrat">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-12">
                <div
                  className={`h-20 w-20 flex items-center justify-center rounded-3xl bg-[${experience.color}]`}
                >
                  <img
              ...
              <div>
                <p className="text-whiteGray  tracking-widest">
                  {experience.date}
                </p>
              </div>
            </div>
