          ...
          <form className="py-12">
            <div className="relative h-11 w-full  min-w-[200px]">
              ...
              <input
                ...
                className="peer text-white h-full w-full pb-5 border-b border-blue-gray-200 bg-transparent pt-4  font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
              />
            </div>
          </form>
        </div>
